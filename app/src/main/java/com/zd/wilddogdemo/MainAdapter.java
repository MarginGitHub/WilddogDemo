...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.UserListViewHolder> {
    ...
    class UserListViewHolder extends RecyclerView.ViewHolder {
        ...
        public UserListViewHolder(View itemView, final MainActivity context) {
            super(itemView);
